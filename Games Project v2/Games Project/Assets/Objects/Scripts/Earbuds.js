...
public class Earbuds extends MonoBehaviour {
	public var earbudWords;
	var displayText = false;
	static var yesButtonClick = false;
	var earbudTake = false;
	...
	function Update () {
		...
		gameObject.tag = "I am a pair of earbuds, ooooooh!";
	...
	function OnGUI() {
		if (displayText) {
			GUI.Box(new Rect(0, 0, Screen.width, Screen.height-200), earbudWords + " Should you take it?");
